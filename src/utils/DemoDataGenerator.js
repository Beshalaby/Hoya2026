        ...
        return [
            ...
            // Rush hour congestion
            {
                ...
                engineering_suggestions: [
                    {
                        type: 'lane',
                        location: 'Northbound Entry',
                        description: 'Add turning lane to reduce queuing emissions',
                        co2_impact: 'high'
                    },
                    {
                        type: 'light',
                        location: 'Intersection Center',
                        description: 'Install smart sensor for dynamic signal timing',
                        co2_impact: 'medium'
                    }
                ]
            },
            // Safety incident
            {
                ...
                engineering_suggestions: [
                    {
                        type: 'sign',
                        location: 'Lane 3 Crosswalk',
                        description: 'Install flashing pedestrian crossing sign',
                        co2_impact: 'low'
                    }
                ]
            },
